...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-10 10:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ff24280c-cab7-4f77-8fa4-51d006d8fbcf.git
$ cd ff24280c-cab7-4f77-8fa4-51d006d8fbcf
```
